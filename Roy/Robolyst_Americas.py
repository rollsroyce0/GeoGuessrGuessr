...
for i in track(range(100)):
    ...
    if i%100<30 and i%100>=20:
        code = 'AUS'
        
    if i%100<40 and i%100>=30:
        code = 'USA'
        
    if i%100<45 and i%100>=40:
        code = 'ARG'
        
    if i%100<50 and i%100>=45:
        code = 'CHL'
        
    if i%100<55 and i%100>=50:
        code = 'PER'
        
    if i%100<60 and i%100>=55:
        code = 'AUS'
    
    if i%100<65 and i%100>=60:
        code = 'AUS'
        
    if i%100<70 and i%100>=65:
        code = 'USA'
        
    if i%100<80 and i%100>=70:
        code = 'RUS'
        
    if i%100<85 and i%100>=80:
        code = 'RUS'
        
    if i%100<90 and i%100>=85:
        code = 'USA'
    
    if i%100<95 and i%100>=90:
        code = 'NZL'
