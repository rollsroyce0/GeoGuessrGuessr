...
def snap_coords(coords):
    ...
    coords[:,1] = np.clip(coords[:,1], -180, 180)
    
    atlantic_north_box = np.array([[-20, -80], [50, -10]])  # North Atlantic
    
    #occlude the atlantic ocean and snap in a straight line east west
