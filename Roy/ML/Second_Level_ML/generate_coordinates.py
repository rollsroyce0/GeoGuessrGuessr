...
def get_real_coordinates(testtype):
    ...
    real_coords_Best = np.array([[59.407269,15.415694], [49.3641445,8.5459606], [-1.5005364,29.621744], [23.874421,90.3919131], [40.2829236,-91.8600552]])
...
def main():
    ...
    for testtype in test_types:
        coords = get_real_coordinates(testtype)
        for idx, coord in enumerate(coords):
            all_coords.append({'test_type': testtype, 'point_index': idx, 'latitude': coord[0], 'longitude': coord[1]})
